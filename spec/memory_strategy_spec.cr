...
module MemoryStrategySpec
  private def build_hir(source : String)
  ...
  describe "Memory strategy" do
    it "marks thread-shared allocations as AtomicARC" do
      ...
      expect(strategies.any?(Crystal::HIR::MemoryStrategy::AtomicARC)).to be_true
    end
  end
end
