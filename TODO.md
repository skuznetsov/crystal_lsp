...
- Update (2026-01-xx): `new` callsites now feed initializer callsite types and trigger lowering; `ArgumentError#initialize` is emitted in `/private/tmp/arg_error.hir` (no more missing `_ArgumentError_initialize`).
