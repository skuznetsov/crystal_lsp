...
eqeq_errors = parser.diagnostics.select { |d| d.message == "unexpected EqEq" }

puts "Found #{eqeq_errors.size} 'unexpected EqEq' errors\n"
puts "=" * 80

eqeq_errors.first(10).each_with_index do |diag, idx|
