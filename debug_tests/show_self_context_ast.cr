...
# Find all "unexpected Self" errors
self_errors = parser.diagnostics.select { |d| d.message == "unexpected Self" }

puts "Found #{self_errors.size} 'unexpected Self' errors"
puts "=" * 80

self_errors.each_with_index do |diag, idx|
