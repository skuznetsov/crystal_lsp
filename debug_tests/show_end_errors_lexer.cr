...
end_errors = parser.diagnostics.select { |d| d.message == "unexpected End" }

puts "Found #{end_errors.size} 'unexpected End' errors"
puts "=" * 80

end_errors.first(10).each_with_index do |diag, idx|
