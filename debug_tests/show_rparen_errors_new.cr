...
# Show actual code examples with "unexpected RParen" errors
found = 0
max_examples = 20

puts "Searching for 'unexpected RParen' errors...\n"
...
Dir.glob("../src/**/*.cr").each do |file|
  ...
  if rparen_errors.size > 0
    rparen_errors.first(2).each do |err|
...
puts "="*70
puts "Showed #{found} examples of 'unexpected RParen' errors"
