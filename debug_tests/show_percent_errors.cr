...
# Show actual code examples with "unexpected Percent" errors
found = 0
max_examples = 20

puts "Searching for 'unexpected Percent' errors...\n"
...
puts "="*70
puts "Showed #{found} examples of 'unexpected Percent' errors"
